                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('jobseeker.register') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="gender" type="radio"  name="gender" value="male" required autocomplete="gender">&nbsp;Male
                                    <input id="gender" type="radio"  name="gender" value="female" required autocomplete="gender">&nbsp;Female
                                    @error('gender')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
